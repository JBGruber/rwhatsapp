...
Overall, WhatsApp data is a fun source to play around with text mining methods.
But if you have more serious data, you can do some proper research, just like with other social media data.

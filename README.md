...
```
## [1] "/home/johannes/Documents/Github/rwhatsapp/inst/extdata/sample.txt"
```
...
## 1 2017-07-12 22:35:00 <NA>      Messages to this group a… <chr … <chr [0]> 
## 2 2017-07-12 22:35:00 <NA>      "You created group \"Tes… <chr … <chr [0]> 
## 3 2017-07-12 22:35:00 Johannes… <Media omitted>           <chr … <chr [0]> 
## 4 2017-07-12 22:35:00 Johannes… Fruit bread with cheddar… <chr … <chr [2]> 
## 5 2017-07-13 09:12:00 Test      "It's fun doing text ana… <chr … <chr [0]> 
## 6 2017-07-13 09:16:00 Johannes… Haha it sure is 😅        <chr … <chr [1]> 
## 7 2018-09-28 13:27:00 Johannes… Did you know there is an… <chr … <chr [0]> 
## 8 2018-09-28 13:28:00 Johannes… 😀😃😄😁😆😅😂🤣☺😊😇🙂🙃😉😌😍😘😗😙😚😋😛😝😜… <chr … <chr [242…
## 9 2018-09-28 13:30:00 Johannes… 🤷‍♀🤷🏻‍♂🙎‍♀🙎‍♂🙍‍♀🙍‍♂💇‍♀💇‍…         <chr … <chr [87]>
```
...
##    time                author    text                     emoji  emoji_name
##    <dttm>              <fct>     <chr>                    <list> <list>    
##  1 2015-12-10 19:57:00 Artur Ku… <Media omitted>          <chr … <chr [0]> 
##  2 2015-12-10 22:31:00 Erika Ils 😂😂😂😂😂😂             <chr … <chr [6]> 
##  3 2015-12-11 02:13:00 Alexandr… 🙈                       <chr … <chr [1]> 
##  4 2015-12-11 02:23:00 Johannes… 😂                       <chr … <chr [1]> 
##  5 2015-12-11 02:24:00 Johannes… Die Petitionen Trump di… <chr … <chr [1]> 
##  6 2015-12-11 03:51:00 Erika Ils Läääuft                  <chr … <chr [0]> 
##  7 2015-12-12 07:49:00 Johannes… <Media omitted>          <chr … <chr [0]> 
##  8 2015-12-12 07:53:00 Erika Ils was macht ihr huete?     <chr … <chr [0]> 
##  9 2015-12-12 07:55:00 Johannes… Alex arbeitet weil sie … <chr … <chr [0]> 
## 10 2015-12-12 07:55:00 Johannes… und ich spiele auf mein… <chr … <chr [0]> 
...
![plot of chunk messages_over_time](https://i.imgur.com/DM4B9xV.png)
...
![plot of chunk messages_per_author](https://i.imgur.com/S7fy23h.png)
...
![plot of chunk emojis](https://i.imgur.com/wvDEvIl.png)
...
![plot of chunk often_used_words](https://i.imgur.com/aIVI1vU.png)
...
![plot of chunk often_used_words_clean](https://i.imgur.com/iPbvw3f.png)
...
![plot of chunk Important_words](https://i.imgur.com/Sg7J0u5.png)
...
![plot of chunk Lexical_Diversity](https://i.imgur.com/0CLsXYl.png)

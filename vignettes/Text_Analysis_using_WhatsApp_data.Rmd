...
``` r
library("tidyte^[Note that most of the analysis below is taken (or heavily inspired) from the book at [tidytextmining.com/](https://www.tidytextmining.com/) where you can also learn much more about text analysis.]xt")
chat %>%
